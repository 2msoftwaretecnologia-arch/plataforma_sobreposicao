...
class Command(BaseCommand):
    help = "Processa dados geoespaciais de prodes em paralelo com particionamento e hash única."
    ...
    def process_partition(self, partition_df, user):
        ...
        for _, row in partition_df.iterrows():
            ...
            try:
                ...
                results.append(obj.identification)
    ...
    def handle(self, *args, **options):
        print("Iniciando processamento de Prodes em threads...")
        ...
        if not archive_path:
            raise CommandError("Nenhum arquivo de Prodes foi configurado.")
        
        if not archive_path.prodes_zip_file.path:
            raise CommandError("Nenhum arquivo de Prodes foi configurado.")
