...
from .models import Quilombolas , Paths, ConservationUnits, MunicipalBoundaries
...
class MunicipalBoundariesAdmin(LeafletGeoAdmin):   
    list_display = ('name', 'hash_id', 'area_ha')
    search_fields = ('name',)
...
admin.site.register(MunicipalBoundaries, MunicipalBoundariesAdmin)