...
class Command(BaseCommand):
    help = "Processa dados geoespaciais de unidades de conservação em paralelo com particionamento e hash única."
    ...
    def process_partition(self, partition_df, user):
        ...
        for _, row in partition_df.iterrows():
            ...
            try:
                obj, created = ConservationUnits.objects.get_or_create(
