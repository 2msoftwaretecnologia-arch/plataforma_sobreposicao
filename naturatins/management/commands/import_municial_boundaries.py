...
class Command(BaseCommand):
    help = "Processa dados geoespaciais de municípios em paralelo com particionamento e hash única."
    ...
    def process_partition(self, partition_df, user):
        ...
        for _, row in partition_df.iterrows():
            ...
            try:
                obj, created = MunicipalBoundaries.objects.get_or_create(
                ...
                if created:
                    GeometryProcessingService(MunicipalBoundaries).process_instance(obj)
                    print(f"[OK] {obj.name}")
                else:
    ...
    def handle(self, *args, **options):
        print("Iniciando processamento de municípios em threads...")
        ...
        print("Processamento paralelo de municípios concluído com sucesso!")
